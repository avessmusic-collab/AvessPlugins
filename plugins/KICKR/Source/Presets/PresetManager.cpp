    ...
    namespace
    {
        ...
        const std::array<Factory, 47> kFactory { {
            ...
            { "Acoustic Rock", { {pid::fundamental,62.0f},{pid::pitchStart,2.2f},{pid::pitchTime,30.0f},
                               {pid::bodyDecay,220.0f},{pid::bodyHarmonics,0.30f},{pid::morph,0.30f},
                               {pid::clickLevel,0.45f},{pid::clickTone,3000.0f},{pid::clickTime,4.0f},
                               {pid::noiseLevel,0.18f},{pid::noiseDecay,45.0f},{pid::noiseTone,0.55f},{pid::noiseType,1.0f},
                               {pid::tailLevel,0.08f},{pid::drive,0.15f},{pid::transientAttack,0.35f},{pid::low,2.0f} } },
            { "Acoustic Jazz", { {pid::fundamental,70.0f},{pid::pitchStart,1.8f},{pid::pitchTime,25.0f},
                               ...
                               {pid::clickLevel,0.30f},{pid::clickTone,2500.0f},{pid::noiseLevel,0.12f},{pid::noiseDecay,40.0f},
            ...
            { "Studio Tight", { {pid::fundamental,58.0f},{pid::pitchStart,2.5f},{pid::pitchTime,28.0f},
                               ...
                               {pid::clickTone,4000.0f},{pid::clickTime,3.0f},{pid::noiseLevel,0.15f},{pid::noiseDecay,35.0f},
                               {pid::transientAttack,0.45f},{pid::transientSustain,-0.20f},{pid::drive,0.20f},
            ...
            { "Vintage Kit",  { {pid::fundamental,56.0f},{pid::pitchStart,2.0f},{pid::pitchTime,35.0f},
                               ...
                               {pid::clickLevel,0.30f},{pid::clickTone,2200.0f},{pid::noiseLevel,0.20f},{pid::noiseDecay,60.0f},
            ...
            { "Metal Kit",    { {pid::fundamental,64.0f},{pid::pitchStart,3.0f},{pid::pitchTime,22.0f},
                               ...
                               {pid::clickTone,5500.0f},{pid::clickPitch,6000.0f},{pid::clickTime,2.5f},
            ...
            { "808 Classic",  { {pid::fundamental,42.0f},{pid::pitchStart,1.6f},{pid::pitchTime,60.0f},
                               {pid::bodyDecay,900.0f},{pid::bodyHarmonics,0.15f},{pid::subLevel,0.60f},{pid::subFreq,40.0f},
                               {pid::subDecay,800.0f},{pid::clickLevel,0.15f},{pid::clickTone,2500.0f},{pid::tailLevel,0.05f},
                               {pid::drive,0.15f},{pid::low,3.0f} } },
            { "808 Long",     { {pid::fundamental,38.0f},{pid::pitchStart,1.4f},{pid::pitchTime,80.0f},
            ...
            { "808 Punch",    { {pid::fundamental,46.0f},{pid::pitchStart,3.0f},{pid::pitchTime,45.0f},
                               ...
                               {pid::subDecay,600.0f},{pid::clickLevel,0.35f},{pid::clickTone,3500.0f},
                               {pid::transientAttack,0.40f},{pid::drive,0.25f},{pid::tailLevel,0.05f},{pid::low,2.0f} } },
            ...
            { "808 Knock",    { {pid::fundamental,45.0f},{pid::pitchStart,2.5f},{pid::pitchTime,40.0f},{pid::pitchCurve,0.80f},
                               ...
                               {pid::clickLevel,0.45f},{pid::clickTone,3000.0f},{pid::clickTime,3.0f},
                               {pid::transientAttack,0.50f},{pid::drive,0.35f},{pid::character,0.10f},
            ...
            { "Boom Bap",     { {pid::fundamental,52.0f},{pid::pitchStart,3.0f},{pid::pitchTime,50.0f},
                               ...
                               {pid::drive,0.45f},{pid::character,0.35f},{pid::driveMix,0.80f},
            ...
            { "Dusty Vinyl",  { {pid::fundamental,50.0f},{pid::pitchStart,2.6f},{pid::pitchTime,45.0f},
                               ...
                               {pid::noiseTone,0.30f},{pid::noiseType,1.0f},{pid::drive,0.50f},{pid::character,0.55f},
            ...
            { "Lo-Fi Knock",  { {pid::fundamental,55.0f},{pid::pitchStart,3.5f},{pid::pitchTime,40.0f},
                               ...
                               {pid::clickTime,3.0f},{pid::transientAttack,0.30f},{pid::drive,0.60f},{pid::character,0.70f},
            ...
            { "Drill",        { {pid::fundamental,40.0f},{pid::pitchStart,2.0f},{pid::pitchTime,70.0f},
                               ...
                               {pid::subDecay,550.0f},{pid::clickLevel,0.30f},{pid::clickTone,4000.0f},{pid::clickTime,2.5f},
            ...
            { "Trap Hard",    { {pid::fundamental,44.0f},{pid::pitchStart,3.5f},{pid::pitchTime,50.0f},
                               ...
                               {pid::subDecay,500.0f},{pid::clickLevel,0.45f},{pid::clickTone,4500.0f},
                               {pid::transientAttack,0.45f},{pid::drive,0.55f},{pid::character,0.30f},{pid::driveMix,0.85f},
            ...
            { "Berlin",       { {pid::fundamental,50.0f},{pid::pitchStart,5.0f},{pid::pitchTime,40.0f},
                               ...
                               {pid::clickTone,4800.0f},{pid::clickTime,2.5f},{pid::tailLevel,0.30f},{pid::tailLength,220.0f},
            ...
            { "Peak Time",    { {pid::fundamental,54.0f},{pid::pitchStart,6.0f},{pid::pitchTime,36.0f},
                               {pid::bodyDecay,210.0f},{pid::clickLevel,0.55f},{pid::clickTone,5500.0f},{pid::clickPitch,6500.0f},
